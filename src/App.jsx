    ...
    <div className={`min-h-screen ${bgClass} w-full flex flex-col items-center justify-center p-4 transition-colors duration-500`}>
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className={`${user.role === "teacher"
            ...
            <h3 className={`text-2xl font-black mb-4 uppercase tracking-wide ${user.role === "teacher" ? "text-slate-800" : "text-emerald-600"
              }`}>
              Confirm Logout
            </h3>
            <p className={`font-bold mb-6 text-sm ${user.role === "teacher" ? "text-slate-500" : "text-slate-600"
              }`}>
            ...
            <div className="flex gap-4">
              <button
                ...
                className={`flex-1 py-3 font-black text-sm rounded-xl transition duration-200 active:scale-[0.98] cursor-pointer ${user.role === "teacher"
